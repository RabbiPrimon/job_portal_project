...
class EmployerModel(models.Model):
    ...
    def __str__(self):
        return self.employer.username if self.employer else 'Employer'
...
class ApplyJobModel(models.Model):
    ...
    def __str__(self):
        return self.applied_by.full_name if self.applied_by and self.applied_by.full_name else 'Application'
